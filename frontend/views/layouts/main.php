  ...
  <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>About</h2>
          <p id='section-p'>Hello. My name is Brenda and I am a professional software devoloper based in Kenya. I have been on this field long enough to develop a deep understanding and appreciation for this career. I am looking forward to working with you towards your desired needs.</p>
        </div>
...
<section id="skills" class="skills section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Skills</h2>
          <p>Over the years, I have managed to interact with different languages and platforms, thus gathering skills. These skills have been vital in building my career hence better production.</p>
        </div>
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <div>
            <img src="theme/assets/img/html5-logo.png" class="img-fluid">
            <H1>HTML</H1>
           </div>
            </div>
            ...
            <div class="progress">
              <div>
            <img src="theme/assets/img/css3-logo.png" class="img-fluid">
            <h1>CSS</h1>
           </div>
            </div>
            ...
            <div class="progress">
              <div>
            <img src="theme/assets/img/js-logo.svg" class="img-fluid">
            <h1>JAVASCRIPT</h1>
           </div>
            </div>
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <div>
            <img src="theme/assets/img/photoshop-logo.jpg" class="img-fluid">
            <h1>PHOTOSHOP</h1>
           </div>
            </div>
            ...
            <div class="progress">
              <div>
            <img src="theme/assets/img/wordpress-logo.svg" class="img-fluid">
            <h1>WORDPRESS</h1>
           </div>
            </div>
            ...
            <div class="progress">
              <div>
            <img src="theme/assets/img/php-logo.svg" class="img-fluid">
            <h1>PHP</h1>
           </div>
            </div>
